...
@bot.on(lightning_cmd(pattern="gnt$"))
...
# by @turquoise-giggle
@bot.on(lightning_cmd(pattern="gmg2$"))
...
# by @turquoise-giggle
@bot.on(lightning_cmd(pattern="gnt2$"))
...
# by  @Halto_Tha
@bot.on(lightning_cmd(pattern=r"lmoon$"))
...
@bot.on(lightning_cmd(pattern=r"city$"))
...
@bot.on(lightning_cmd(pattern=r"hi ?(.*)"))
...
@bot.on(lightning_cmd(pattern=r"cheer$"))
...
@bot.on(lightning_cmd(pattern=r"getwell$"))
...
@bot.on(lightning_cmd(pattern=r"luck$"))
...
@bot.on(lightning_cmd(pattern=r"sprinkle$"))
