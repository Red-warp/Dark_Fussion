...
#Import Gudz
RUN wget https://raw.githubusercontent.com/TeamFussion/Dark_Fussion/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/Teamfussion/Dark_Fussion/master/requirements.txt
#Start Fumkin
